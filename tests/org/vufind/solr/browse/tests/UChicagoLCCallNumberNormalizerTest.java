...
public class UChicagoLCCallNumberNormalizerTest
{
    ...
    @Test
    public void testXXKSortKey() {
    	String call = "XXKD671.G53";
    	
    	String normal = new String(this.ucLCNormalizer.normalize(call));
    	assertEquals("XXKD", normal.subSequence(0, 4));
    }
    
    @Test
    public void sortsUChicagoLCClassification() {
        assertEquals(Helpers.listOf("AB9.22 L3", "ABR92.L3", "B82 L3", "B82.2 L3", "B822 L3", "B8220 L3"
        		, "KD671.G53", "XXKD671.G52", "XXKD671.G53", "XXKFA 207.A940"),
        		Helpers.sort(ucLCNormalizer,
        				Helpers.listOf("B822 L3", "XXKFA 207.A940", "B82 L3", "XXKD671.G53", 
        						"B8220 L3", "KD671.G53", "AB9.22 L3", "ABR92.L3", "B82.2 L3", "XXKD671.G52")));
    }
